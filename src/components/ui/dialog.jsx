  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      <DialogPrimitive.Close
        className="absolute right-4 top-4 rounded-lg p-1.5 opacity-60 hover:opacity-100 transition-opacity focus:outline-none focus:ring-2 focus:ring-slate-200 disabled:pointer-events-none data-[state=open]:bg-slate-100">
